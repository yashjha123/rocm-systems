...
// Expected values were captured on physical gfx1201. Transcendentals ignore FP_ROUND, and F32
// forms ignore FP_DENORM; the mode-named cases below record that behavior.
constexpr std::array<PseudoScalarSpecialCase, 85> kSpecialCases{{
    ...
    {"literal_f16_low_half",
     ...
     0x00004000u,
     "0x4400",
     {.use_literal = true, .literal = 0xCAFE4400u}},
    ...
    {"f32_input_denorm_allow", "v_s_log_f32", 0x00000001u, 0xFF800000u, "", {}, 1u << 4},
    {"f32_output_denorm_allow", "v_s_exp_f32", f32_bits(-149.0f), 0x00000000u, "", {}, 1u << 5},
    {"f32_ignores_f16_output_denorm_mode",
     ...
     {},
     1u << 7},
    {"f16_input_denorm_allow", "v_s_log_f16", 0xCAFE0001u, 0x0000CE00u, "", {}, 1u << 6},
    {"f16_output_denorm_allow", "v_s_exp_f16", 0xCAFECE00u, 0x00000001u, "", {}, 1u << 7},
    {"f32_round_toward_positive", "v_s_exp_f32", f32_bits(0.5f), 0x3FB504F3u, "", {}, 1u},
    {"f16_round_toward_positive", "v_s_exp_f16", 0xCAFE3800u, 0x00003DA8u, "", {}, 1u << 2},
    ...
    {"f16_round_toward_negative", "v_s_sqrt_f16", 0xCAFE4200u, 0x00003EEEu, "", {}, 2u << 2},
    {"f16_round_toward_zero", "v_s_sqrt_f16", 0xCAFE4200u, 0x00003EEEu, "", {}, 3u << 2},
    ...
    {"f16_negative_round_toward_negative",
     ...
     {},
     2u << 2},
    {"f16_negative_round_toward_zero", "v_s_rcp_f16", 0xCAFEC200u, 0x0000B555u, "", {}, 3u << 2},
    ...
    {"f32_destination_underflow_round_toward_zero",
     ...
     {},
     3u | (1u << 5)},
    {"f16_destination_overflow_round_to_nearest", "v_s_exp_f16", 0xCAFE4C00u, 0x00007C00u, "", {}},
    ...
    {"f16_log_negative_domain", "v_s_log_f16", 0xCAFEBC00u, 0x0000FE00u, "", {}},
    {"f16_rsq_negative_domain", "v_s_rsq_f16", 0xCAFEBC00u, 0x0000FE00u, "", {}},
    {"f16_sqrt_negative_domain", "v_s_sqrt_f16", 0xCAFEBC00u, 0x0000FE00u, "", {}},
    {"f16_finite_overflow_round_toward_zero",
     ...
     {},
     3u << 2},
    {"f16_finite_overflow_round_to_nearest", "v_s_exp_f16", 0xCAFE7BFFu, 0x00007C00u, "", {}},
    ...
    {"f16_omod_flushes_output_denorm",
     ...
     {.omod = 1},
     1u << 7},
    {"f16_clamp_maps_nan_to_zero", "v_s_sqrt_f16", 0xCAFEBC00u, 0x00000000u, "", {.clamp = true}},
    ...
    {"f16_clamp_normalizes_negative_zero",
     ...
     "",
     {.clamp = true}},
    {"f16_unclamped_preserves_negative_zero", "v_s_sqrt_f16", 0xCAFE8000u, 0x00008000u, "", {}},
}};
...
TEST(PseudoScalarHelperTest, PreservesAndFlushesSignedDenormals) {
  ...
  EXPECT_EQ(amdgpu::pseudo_scalar::execute_f32(Operation::SQRT, f32_negative_minimum, false, false,
                                               0, 0, 0, false),
            0x80000000u);
  // F32 transcendentals flush source subnormals in every FP_DENORM mode.
  EXPECT_EQ(amdgpu::pseudo_scalar::execute_f32(Operation::SQRT, f32_negative_minimum, false, false,
                                               0, 1, 0, false),
            0x80000000u);
...
TEST(PseudoScalarModeIntegrationTest, SetregInstructionsUpdateModesConsumedByPseudoScalars) {
  ...
  for (const PseudoScalarProfile &profile : kProfiles) {
    ...
    // Physical transcendentals round to nearest even regardless of FP_ROUND.
    ...
    const InstructionWords log_words =
        encode_vop3(profile, "v_s_log_f16", kDestinationSgpr, kSourceSgpr);
